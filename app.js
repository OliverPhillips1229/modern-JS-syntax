...
const userProfile = {
  [propertyName]: 'oliver_levine',
};

console.log(userProfile);
// Prints: { username: 'oliver_levine' }
...
describeAnimal(); // Prints: The cat is orange.
...
// The same logic can be expressed more concisely using a ternary operator:
const age = 22;
...
const pizzaReaction = pizza === 'tasty' ? 'yum' : 'yuck';
console.log(pizzaReaction); // Prints: 'yum'
...
// result2: 243
// result3: false
// result4: 3000 (assuming myVar is undefined or falsy)
